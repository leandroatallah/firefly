...
- Write `PROGRESS.md` inside that folder with Stage "Story Architect" marked ✅ and all others ⬜.
...
- `.agents/work/backlog/[ID]-[slug]/PROGRESS.md` with initial pipeline status.
